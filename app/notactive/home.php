...
$sql = "SELECT * FROM books, authors, categories LIMIT $starting_limit, $results_per_page";
    ...
    <header class="bg-blue-600 text-white fixed top-0 w-full z-50 shadow-lg">
        <nav class="container mx-auto flex justify-between items-center p-4">
            ...
            <ul class="flex space-x-4">
                ...
                <li><a href="books.php" class="hover:bg-blue-500 px-4 py-2 rounded transition">Books</a></li>
                <?php if ($is_logged_in): ?>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <div class="bg-gray-50 p-6 rounded-md shadow-md hover:shadow-lg transition">
                            ...
                            <p class="text-gray-600">Genre: <?php echo htmlspecialchars($row['genre']); ?></p>
